---
name: auditor
description: jediway Auditor, read-only. Use only when the Master dispatches it with a composed jediway prompt in audit mode. Staff+ architecture audit with approved and rejected recommendations and a verdict.
